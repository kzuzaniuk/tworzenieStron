...
const MainContent = (props) => {
    return (
        <div className={maincontentStyles.intro}>
            ...
            <img src={props.source} alt="maincontentimage"></img>
            <Link to={props.goto} className={maincontentStyles.button}>See more</Link>
            </div>

            <div className={maincontentStyles.tekst}>
            <h3>{props.he}</h3>
            <p>{props.tekst}</p> {/*Jeśli będzie więcej tekstu to trzeba rozbić na więcej paragrafów i lepiej ogarnąć przesyłanie*/}
